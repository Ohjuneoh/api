...
public class GenericWildCardApp {
	...
	public static void main(String[] args) {
		 ...
		 * <? extends 타입>
		 * <? super 타입>
		 *  - 제네릭 와일드카드는 메소드의 매개변수, 메소드의 반환타입에 사용된다.
...
//		GenericBox<Object> box1 = new GenericBox<Integer>(); //제네릭에서 Integer과 Object는 상속관계가 아님
...
//		test4(new GenericBox<SmartPhone>());
	...
	//GenericBox 객체의 타입파라미터가 Number거나 Number의 하위타입인 것만 전달받을 수 있다.
	public static void test3(GenericBox<? extends Number> box) {
		
	}
	
	//GenericBox 객체의 타입파라미터가 FeaturePhone이거나 FeaturePhone의 상위타입인 것만 전달

...
public class DateTimeFormatApp {
	
	public static void main(String[] args) {
		/*
		 * java.text.SimpleDateTimeFormat
		 *  - Date 객체의 날짜와 시간정보를 지정한 형식의 문자열로 변환한다.
		 *  - 날짜형식의 문자열을 해석해서 Date객체로 변환한다. 
		 *  
		 *   주요 API
		 *   	생성자
		 *   		SimpleDateFormat(String pattern)
		 *  			지정된 패턴으로 초기화된 SimpleDateFormat 객체를 생성한다.
		 *  	메소드
...
//		String pattern = "yyyy-MM-dd HH:mm:ss";
		...
		//Date객체(날짜와 시간정보)를 지정된 형식의 패턴형식의 문자열로 변환하기
